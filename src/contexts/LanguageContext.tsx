...
const translations: Translations = {
  ...
  'nav.profiles': { es: 'Contactos', en: 'Contacts' },
  ...
  'dashboard.range.week': { es: 'Esta semana', en: 'This week' },
  'dashboard.range.month': { es: 'Este mes', en: 'This month' },
  'dashboard.range.year': { es: 'Este año', en: 'This year' },
  'dashboard.range.all': { es: 'Histórico', en: 'All time' },
  'dashboard.incomeVsExpenses': { es: 'Ingresos vs Gastos', en: 'Income vs Expenses' },
  'dashboard.both': { es: 'Ambos', en: 'Both' },
  ...
  'profiles.quickCreate': { es: 'Crear nuevo contacto', en: 'Create new contact' },
  'profiles.noProfileOption': { es: 'Usuario', en: 'User' },
